...
namespace HTMLConverter
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        /// sets the FontSize for the HTML
        /// </param>
        /// <param name="_fontFamily">
        /// sets the FontFamily for the HTML
        /// </param>
        /// <returns>
        /// Well-formed xml representing XAML equivalent for the input html string.
        /// </returns>
        public static string ConvertHtmlToXaml(string htmlString, bool asFlowDocument, int _fontSize, string _fontFamily)
        {
        ...
        {
            //  Implement images (HACK by Nigel Spencer)
            bool inLine = (xamlParentElement.Name == HtmlToXamlConverter.Xaml_Paragraph);

            XmlElement xamlUIContainerElement = null;

            if (inLine)
                xamlUIContainerElement = xamlParentElement.OwnerDocument.CreateElement(null, "InlineUIContainer", _xamlNamespace);
            else
                xamlUIContainerElement = xamlParentElement.OwnerDocument.CreateElement(null, "BlockUIContainer", _xamlNamespace);

            XmlElement xamlImageElement = xamlParentElement.OwnerDocument.CreateElement(null, "Image", _xamlNamespace);
        ...
        private static Hashtable GetElementProperties(XmlElement htmlElement, Hashtable inheritedProperties, out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            localProperties["font-size"] = FontSize + "px"; // TOM Font Change
            localProperties["font-family"] = FontFamily;    // TOM Font Change
