...
namespace RSSModule
{
    public class RSSPanel : Panel, IWeakEventListener
    {
        public RSSPanel()
        {
            LayoutUpdatedEventManager.AddListener(this, this);
        }
        ...
        private void RSSPanel_LayoutUpdated(object sender, EventArgs e)
        {
            if (_visualParent != null)
            {
        ...
        {
            if (managerType == typeof(LayoutUpdatedEventManager))
            {
                RSSPanel_LayoutUpdated(sender, e);
                return true;
            }
            return false;
        }
