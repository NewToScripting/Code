...
namespace VideoModule
{
    public class DesignVideoModule : MediaModule, IMediaModule
    {
        ...
        public DesignContentControl Execute(double canvasWidth, double canvasHeight)
        {
            ...
            openFileDialog.Filter = "Videos (*.wmv, *.mp4, *.3g2, *.3gp, *.m4v, *.m2v, *.flv, *.mpg, *.avi, *.asx, *.mkv, *.mpeg) |*.wmv; *.mp4; *.3g2; *.3gp; *.m4v; *.m2v; *.flv; *.mpg; *.avi; *.asx; *.mkv; *.mpeg";
        ...
        {
            return new List<string> { ".wmv", ".mp4", ".3g2", ".3gp", ".m4v", ".m2v", ".flv", ".mpg", ".avi", ".asx", ".mkv", ".mpeg" };
        }
