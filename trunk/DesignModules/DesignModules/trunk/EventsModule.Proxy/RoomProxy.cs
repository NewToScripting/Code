...
namespace Inspire.Events.Proxy
{
    ...
    public class RoomProxy
    {
        ...
        static public List<Room> GetRooms()
        {
            ...
            {
                ProxyErrorHandler.Throw(e, "Error occured while getting rooms");
            }
        ...
        { 
            ...
            {
                ProxyErrorHandler.Throw(e, "Error occured while getting rooms for display");
            }
        ...
        static public void AddRoom(Room room)
        {
            ...
            {
                ProxyErrorHandler.Throw(e, "Error occured while adding rooms");
            }
         ...
         static public void AddRoomToDisplayAssn(string roomID, string displayID)
        {
             ...
             {
                 ProxyErrorHandler.Throw(e, "Error occured while adding room to display assn");
             }
        ...
        /// <param name="displayID"></param>
         static public void DeleteRoomToDisplayAssn(string roomID, string displayID)
         {
             ...
             {
                 ProxyErrorHandler.Throw(e, "Error occured while deleting room to display assn");
             }
         }  
        ...
        static public void DeleteRoom(string roomID)
        {
            ...
            {
                ProxyErrorHandler.Throw(e, "Error occured while deleting room");
            }
        }
        ...
        private static Inspire.Events.Proxy.RoomsService.Room RoomToProxyRoom(Inspire.Events.Proxy.Room from)
        {
            ...
            to.Aliases = AliaseProxy.AliasesToProxyAliases(from.Aliases);
            to.GUID = from.Guid;
            to.Name = from.Name;
        ...
        private static Inspire.Events.Proxy.Room proxyRoomToRoom(Inspire.Events.Proxy.RoomsService.Room from)
        {
            ...
            to.Aliases = AliaseProxy.ProxyAliasesToAliases(from.Aliases);
            to.Guid = from.GUID;
            to.Name = from.Name;
