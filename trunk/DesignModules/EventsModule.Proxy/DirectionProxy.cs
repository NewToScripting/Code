...
namespace Inspire.Events.Proxy
{
    ...
    public class DirectionProxy
    {
        ...
        static public List<Direction> GetDirections(string displayID)
        {
            ...
            {
                ProxyErrorHandler.LogError(e, "Error occured while getting directions");
            }
       ...
       /// <param name="directions"></param>
        static public void AddDirections(List<Direction> directions)
        {
           ...
           {
               ProxyErrorHandler.LogError(e, "Error occured while adding directions");
           }
        ...
        static public void DeleteDirections(string displayID)
        {
            ...
            {
                ProxyErrorHandler.LogError(e, "Error occured while deleting directions");
            }
        ...
        //    catch (Exception e)
        //    {
        //        ProxyErrorHandler.LogError(e, "Error occured while deleting directional images");
        //    }
        ...
        //    catch (Exception e)
        //    {
        //        ProxyErrorHandler.LogError(e, "Error occured while adding directional images");
        //    }
