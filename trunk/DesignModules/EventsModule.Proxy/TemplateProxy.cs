...
namespace Inspire.Events.Proxy
{
    ...
    public class FeedTemplateProxy
    {
            ...
            static public List<FeedTemplate> GetTemplates()
            {
                ...
                {
                    ProxyErrorHandler.LogError(e, "Error occured while getting templates ");
                }
            ...
            { 
                ...
                {
                    ProxyErrorHandler.LogError(e, "Error occured while getting single template");
                }
                finally
                {
            ...
            static public void AddTemplate(FeedTemplate template)
            {
                try
                {
                    ...
                    using (Stream inStream = new MemoryStream(template.File))
                    {
                ...
                {
                    ProxyErrorHandler.LogError(e, "Error occured while adding template");
                }
            ...
            static public void DeleteTemplate(string templateID)
            {
                ...
                {
                    ProxyErrorHandler.LogError(e, "Error occured while deleting template");
                }
