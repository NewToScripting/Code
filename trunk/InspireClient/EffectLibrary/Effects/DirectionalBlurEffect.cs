...
namespace EffectLibrary.Effects
{
    ...
    /// </summary>
    public class DirectionalBlurEffect : ShaderEffect, ICustomEffect
    {
        ...
        System.Windows.Controls.UserControl ICustomEffect.GetEffectGrid(UIElement uiElement)
        {
            return new DirectionalBlurGrid(uiElement);
        }
