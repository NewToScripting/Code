...
{
    public class AlignBottomCommand : IDesignerCommand
    {
        #region Properties
        ...
        public AlignBottomCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
