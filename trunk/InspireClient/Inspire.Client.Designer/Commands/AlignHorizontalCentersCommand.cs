...
{
    public class AlignHorizontalCentersCommand : IDesignerCommand
    {
        #region Properties
        ...
        public AlignHorizontalCentersCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements horizontally aligned [" + Elements.GetType().Name + "]";
            }
            set
            {
                // May just need get.
