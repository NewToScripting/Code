...
{
    public class AlignLeftCommand : IDesignerCommand
    {
        #region Properties
        ...
        public AlignLeftCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
