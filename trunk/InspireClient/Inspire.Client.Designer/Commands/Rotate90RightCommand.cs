...
{
    public class Rotate90RightCommand : IDesignerCommand
    {
        #region Properties
        ...
        public Rotate90RightCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Rotated Right 90[" + Elements.GetType().Name + "]";
            }
            set
            {
                // May just need get.
