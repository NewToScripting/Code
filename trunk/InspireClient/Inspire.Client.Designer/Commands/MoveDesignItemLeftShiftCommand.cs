...
{
    public class MoveDesignItemLeftShiftCommand: IDesignerCommand
    {
        ...
        public MoveDesignItemLeftShiftCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements moved shift left";
            }
            set
            {
                // May just need get.
