...
{
    public class AlignVerticalCentersCommand : IDesignerCommand
    {
        #region Properties
        ...
        public AlignVerticalCentersCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements centers aligned [" + Elements.GetType().Name + "]";
            }
            set
            {
                // May just need get.
