...
{
    public class MoveDesignItemDownShiftCommand: IDesignerCommand
    {
        ...
        public MoveDesignItemDownShiftCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements moved shift-down";
            }
            set
            {
                // May just need get.
