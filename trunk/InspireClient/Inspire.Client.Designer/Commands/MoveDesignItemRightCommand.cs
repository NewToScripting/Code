...
{
    public class MoveDesignItemRightCommand : IDesignerCommand
    {
        ...
        public MoveDesignItemRightCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
