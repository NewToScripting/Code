...
{
    public class DistributeVerticalCommand : IDesignerCommand
    {
        #region Properties
        ...
        public DistributeVerticalCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
