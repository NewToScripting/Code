...
{
    public class MoveDesignItemUpShiftCommand: IDesignerCommand
    {
        ...
        public MoveDesignItemUpShiftCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements moved shift up";
            }
            set
            {
                // May just need get.
