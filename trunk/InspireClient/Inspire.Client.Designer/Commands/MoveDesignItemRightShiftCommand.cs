...
{
    public class MoveDesignItemRightShiftCommand : IDesignerCommand
    {
        ...
        public MoveDesignItemRightShiftCommand(ObservableCollection<ContentControl> canvasItems, List<ISelectable> elements, DragCanvas.DragCanvas dragCanvas)
        {
        ...
        public string Title
        {
            get
            {
                return "Elements moved shift right";
            }
            set
            {
                // May just need get.
