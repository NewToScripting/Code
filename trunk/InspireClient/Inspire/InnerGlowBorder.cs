...
namespace Inspire
{
    ...
    /// </summary>
    public class InnerGlowBorderControl : ContentControl
    {
        /// <summary>
        /// The inner glow opacity property.
        /// </summary>
        public static readonly DependencyProperty InnerGlowOpacityProperty =
            DependencyProperty.Register("InnerGlowOpacity", typeof(double), typeof(InnerGlowBorderControl), null);

        /// <summary>
        /// The inner glow size property.
        /// </summary>
        public static readonly DependencyProperty InnerGlowSizeProperty =
            DependencyProperty.Register("InnerGlowSize", typeof(Thickness), typeof(InnerGlowBorderControl), new PropertyMetadata(new PropertyChangedCallback(InnerGlowSize_Changed)));

        /// <summary>
        /// The corner radius property.
        /// </summary>
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register("CornerRadius", typeof(CornerRadius), typeof(InnerGlowBorderControl), null);

        /// <summary>
        /// The inner glow color.
        /// </summary>
        public static readonly DependencyProperty InnerGlowColorProperty =
            DependencyProperty.Register("InnerGlowColor", typeof(Color), typeof(InnerGlowBorderControl), new PropertyMetadata(new PropertyChangedCallback(InnerGlowColor_Changed)));

        /// <summary>
        /// The clip content property.
        /// </summary>
        public static readonly DependencyProperty ClipContentProperty =
            DependencyProperty.Register("ClipContent", typeof(bool), typeof(InnerGlowBorderControl), null);

        /// <summary>
        /// The content z-index property.
        /// </summary>
        public static readonly DependencyProperty ContentZIndexProperty =
            DependencyProperty.Register("ContentZIndex", typeof(int), typeof(InnerGlowBorderControl), null);
        ...
        /// </summary>
        public InnerGlowBorderControl()
        {
            this.DefaultStyleKey = typeof(InnerGlowBorderControl);
        }
        ...
        {
            InnerGlowBorderControl innerGlowBorder = (InnerGlowBorderControl)dependencyObject;
