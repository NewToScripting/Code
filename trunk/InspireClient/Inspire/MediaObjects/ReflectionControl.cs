...
namespace Inspire.MediaObjects
{
    public class ReflectionControl : Decorator
    {
        ...
        public static ContentControl CreateReflection(DesignContentControl contentControl)
        {
            ReflectionControl reflectionControl = new ReflectionControl();
            reflectionControl.Child = contentControl;
            contentControl.Content = reflectionControl;
