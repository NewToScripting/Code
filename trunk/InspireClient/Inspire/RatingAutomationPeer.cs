...
namespace Inspire
{
    ...
    //    /// </param>
    //    public RatingItemAutomationPeer(RatingItem owner) : base(owner)
    //    {
    //    }
    ...
    //    protected override string GetNameCore()
    //    {
    //        int? index = this.OwnerRatingItem.ParentRating.GetRatingItems().ToList().IndexOf(this.OwnerRatingItem);
    //        if (index != null)
    //        {
