...
{
    public class RotateRightTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(RotateRightTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(RotateRightTransition), new UIPropertyMetadata(90.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(RotateRightTransition), new UIPropertyMetadata(RotateDirection.Right));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(RotateRightTransition), new UIPropertyMetadata(true));
    ...
    //public class RotateRightTransition : Transition3D
    //{
    //    static RotateRightTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(RotateRightTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public RotateRightTransition()
    //    {
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(RotateRightTransition), new UIPropertyMetadata(false));
