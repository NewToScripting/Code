...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutBottomInTop : Transition
    {
        static SlideOutBottomInTop()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutBottomInTop), new FrameworkPropertyMetadata(true));
        }

        public SlideOutBottomInTop()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutBottomInTop), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutBottomInTop), new UIPropertyMetadata(new Point()));
