...
{
    public class TurnOverDownTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(TurnOverDownTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverDownTransition), new UIPropertyMetadata(0.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(TurnOverDownTransition), new UIPropertyMetadata(RotateDirection.Down));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverDownTransition), new UIPropertyMetadata(true));
        ...
        protected override void BeginTransition3D(TransitionElement transitionElement, ContentPresenter oldContent, ContentPresenter newContent, Viewport3D viewport)
        {
            ...
            else
            {
                if (Contained)
                {
                   ...
                   // y.EasingFunction = new BackEase {Amplitude = 0.3, EasingMode = EasingMode.EaseOut};
    ...
    //public class TurnOverDownTransition : Transition3D
    //{
    //    static TurnOverDownTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(TurnOverDownTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public TurnOverDownTransition()
    //    {
    ...
    //    public static readonly DependencyProperty AngleProperty =
    //        DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverDownTransition), new UIPropertyMetadata(90.0), IsAngleValid);
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverDownTransition), new UIPropertyMetadata(false));
