...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutLeftInRight : Transition
    {
        static SlideOutLeftInRight()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutLeftInRight), new FrameworkPropertyMetadata(true));
        }

        public SlideOutLeftInRight()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutLeftInRight), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutLeftInRight), new UIPropertyMetadata(new Point()));
