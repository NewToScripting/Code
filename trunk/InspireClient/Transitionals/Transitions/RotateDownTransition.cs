...
{
    public class RotateDownTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(RotateDownTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(RotateDownTransition), new UIPropertyMetadata(90.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(RotateDownTransition), new UIPropertyMetadata(RotateDirection.Down));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(RotateDownTransition), new UIPropertyMetadata(true));
    ...
    //public class RotateDownTransition : Transition3D
    //{
    //    static RotateDownTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(RotateDownTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public RotateDownTransition()
    //    {
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(RotateDownTransition), new UIPropertyMetadata(false));
