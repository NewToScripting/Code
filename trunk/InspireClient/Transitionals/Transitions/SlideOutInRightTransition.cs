...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutInRightTransition  : Transition
    {
        static SlideOutInRightTransition()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutInRightTransition), new FrameworkPropertyMetadata(true));
        }

        public SlideOutInRightTransition()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutInRightTransition), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutInRightTransition), new UIPropertyMetadata(new Point()));
