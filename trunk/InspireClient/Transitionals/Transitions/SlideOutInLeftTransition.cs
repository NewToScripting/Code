...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutInLeftTransition : Transition
    {
        static SlideOutInLeftTransition()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutInLeftTransition), new FrameworkPropertyMetadata(true));
        }

        public SlideOutInLeftTransition()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutInLeftTransition), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutInLeftTransition), new UIPropertyMetadata(new Point()));
