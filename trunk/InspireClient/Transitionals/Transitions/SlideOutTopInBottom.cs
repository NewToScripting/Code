...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutTopInBottom : Transition
    {
        static SlideOutTopInBottom()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutTopInBottom), new FrameworkPropertyMetadata(true));
        }

        public SlideOutTopInBottom()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutTopInBottom), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutTopInBottom), new UIPropertyMetadata(new Point()));
