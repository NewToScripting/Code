...
{
    public class TurnOverLeftTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(TurnOverLeftTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverLeftTransition), new UIPropertyMetadata(0.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(TurnOverLeftTransition), new UIPropertyMetadata(RotateDirection.Left));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverLeftTransition), new UIPropertyMetadata(true));
    ...
    //public class TurnOverLeftTransition : Transition3D
    //{
    //    static TurnOverLeftTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(TurnOverLeftTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public TurnOverLeftTransition()
    //    {
    ...
    //    public static readonly DependencyProperty AngleProperty =
    //        DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverLeftTransition), new UIPropertyMetadata(90.0), IsAngleValid);
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverLeftTransition), new UIPropertyMetadata(false));
