...
{
    public class TurnOverRightTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(TurnOverRightTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverRightTransition), new UIPropertyMetadata(0.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(TurnOverRightTransition), new UIPropertyMetadata(RotateDirection.Right));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverRightTransition), new UIPropertyMetadata(true));
    ...
    //public class TurnOverRightTransition : Transition3D
    //{
    //    static TurnOverRightTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(TurnOverRightTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public TurnOverRightTransition()
    //    {
    ...
    //    public static readonly DependencyProperty AngleProperty =
    //        DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverRightTransition), new UIPropertyMetadata(90.0), IsAngleValid);
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverRightTransition), new UIPropertyMetadata(false));
