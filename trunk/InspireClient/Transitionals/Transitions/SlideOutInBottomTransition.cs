...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutInBottomTransition : Transition
    {
        static SlideOutInBottomTransition()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutInBottomTransition), new FrameworkPropertyMetadata(true));
        }

        public SlideOutInBottomTransition()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutInBottomTransition), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutInBottomTransition), new UIPropertyMetadata(new Point()));
