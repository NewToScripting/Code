...
{
    public class RotateUpTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(RotateUpTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(RotateUpTransition), new UIPropertyMetadata(90.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(RotateUpTransition), new UIPropertyMetadata(RotateDirection.Up));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(RotateUpTransition), new UIPropertyMetadata(true));
    ...
    //public class RotateUpTransition : Transition3D
    //{
    //    static RotateUpTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(RotateUpTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public RotateUpTransition()
    //    {
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(RotateUpTransition), new UIPropertyMetadata(false));
