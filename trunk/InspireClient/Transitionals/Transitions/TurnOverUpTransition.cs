...
{
    public class TurnOverUpTransition : Transition3D
    {
        ...
        public static readonly DependencyProperty DurationProperty =
            DependencyProperty.Register("Duration", typeof(Duration), typeof(TurnOverUpTransition), new UIPropertyMetadata(Duration.Automatic));
        ...
        public static readonly DependencyProperty AngleProperty =
            DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverUpTransition), new UIPropertyMetadata(0.0), IsAngleValid);
        ...
        public static readonly DependencyProperty DirectionProperty =
            DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(TurnOverUpTransition), new UIPropertyMetadata(RotateDirection.Up));
        ...
        public static readonly DependencyProperty ContainedProperty =
            DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverUpTransition), new UIPropertyMetadata(true));
    ...
    //public class TurnOverUpTransition : Transition3D
    //{
    //    static TurnOverUpTransition()
    //    {
    //        AcceptsNullContentProperty.OverrideMetadata(typeof(TurnOverUpTransition), new FrameworkPropertyMetadata(NullContentSupport.Both));
    //    }

    //    public TurnOverUpTransition()
    //    {
    ...
    //    public static readonly DependencyProperty AngleProperty =
    //        DependencyProperty.Register("Angle", typeof(double), typeof(TurnOverUpTransition), new UIPropertyMetadata(90.0), IsAngleValid);
    ...
    //    public static readonly DependencyProperty ContainedProperty =
    //        DependencyProperty.Register("Contained", typeof(bool), typeof(TurnOverUpTransition), new UIPropertyMetadata(false));
