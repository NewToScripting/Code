...
namespace Transitionals.Transitions
{
    ...
    public class SlideOutInTopTransition : Transition
    {
        static SlideOutInTopTransition()
        {
            ClipToBoundsProperty.OverrideMetadata(typeof(SlideOutInTopTransition), new FrameworkPropertyMetadata(true));
        }

        public SlideOutInTopTransition()
        {
        ...
        public static readonly DependencyProperty StartPointProperty =
            DependencyProperty.Register("StartPoint", typeof(Point), typeof(SlideOutInTopTransition), new UIPropertyMetadata(new Point()));
        ...
        public static readonly DependencyProperty EndPointProperty =
            DependencyProperty.Register("EndPoint", typeof(Point), typeof(SlideOutInTopTransition), new UIPropertyMetadata(new Point()));
